...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultAddress: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    notices: Schema.Attribute.Text;
    orderStatus: Schema.Attribute.Enumeration<
      ['pending', 'delivered', 'cancelled', 'inprogress']
    > &
      Schema.Attribute.DefaultTo<'pending'>;
    orderType: Schema.Attribute.String;
    pickupAddress: Schema.Attribute.String;
    pickupLag: Schema.Attribute.Decimal;
    pickupLat: Schema.Attribute.Decimal;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    userRole: Schema.Attribute.Enumeration<['admin', 'call-center', 'courier']>;
  };
}
